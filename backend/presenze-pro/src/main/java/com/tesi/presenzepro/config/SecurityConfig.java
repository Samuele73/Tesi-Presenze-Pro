    ...
    public SecurityFilterChain securityFilterChain (HttpSecurity http) throws Exception{
        return http
                .authorizeHttpRequests(
                        req -> req.requestMatchers("/users/login/**", "/ws/**", "/topic/**", "/users/signin/**", "/users/invitation-details", "/v3/api-docs/**", "/swagger-ui/**", "/swagger-ui.html", "/users/verify-invitation", "/users/resetPassword", "/users/changePassword", "/users/savePassword")
                                .permitAll()
                                .anyRequest()
                                .authenticated()
                )
